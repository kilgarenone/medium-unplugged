...
!(function (e, t) {
  ...
  return (function e() {
    ...
    var et = "http://www.w3.org/1998/Math/MathML",
      ...
      mt = function (e, t, n) {
        if (He && ("id" === t || "name" === t) && (n in o || n in Ye))
          return !1;
        if (De && T(he, t));
        else if (_e && T(ye, t));
        else {
      ...
      pt = function e(t) {
        ...
        for (ut("beforeSanitizeShadowDOM", t, null); (n = r.nextNode()); )
          ut("uponSanitizeShadowNode", n, null),
            ft(n) || (n.content instanceof a && e(n.content), dt(n));
    ...
    return (
      (n.sanitize = function (e, o) {
        ...
        if (
          (Le || Xe(o), (n.removed = []), "string" == typeof e && (je = !1), je)
        );
        else if (e instanceof c)
          (1 ===
            (l = (i = at("\x3c!----\x3e")).ownerDocument.importNode(e, !0))
              .nodeType &&
            "BODY" === l.nodeName) ||
          "HTML" === l.nodeName
            ? (i = l)
          ...
          if (!Fe && !Ne && !Oe && -1 === e.indexOf("<"))
            return oe && ze ? oe.createHTML(e) : e;
          if (!(i = at(e))) return Fe ? null : ie;
        }
        i && Me && ot(i.firstChild);
        for (var m = lt(je ? e : i); (s = m.nextNode()); )
          (3 === s.nodeType && s === u) ||
            ft(s) ||
            (s.content instanceof a && pt(s.content), dt(s), (u = s));
        ...
        return (
          Ne && ((d = y(d, pe, " ")), (d = y(d, ge, " "))),
          oe && ze ? oe.createHTML(d) : d
        );
      }),
